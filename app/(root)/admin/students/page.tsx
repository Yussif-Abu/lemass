...
function parseSorting(value: string | undefined): SortingState {
  ...
  const sortableColumns = new Set(['name', 'id', 'studentId', 'program', 'level', 'gpa', 'attendance', 'status'])
...
export default async function StudentsPage({ searchParams }: StudentsPageProps) {
  ...
  return <StudentsTable initialData={students} initialUrlState={initialUrlState} />
}
